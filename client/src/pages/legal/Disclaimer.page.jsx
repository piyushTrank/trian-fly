  ...
  return (
    <div className="cm-section cm-legal-content-container">
      <div className="cm-page-center cm-lr-pad">
        ...
        <p>
          Trian Fly uses reasonable efforts to ensure that information contained
          ...
          to and remain solely with Trian Fly. Users are solely responsible for
          the use and protection of their user ID/ password used on our website.
        </p>
        <p>
          Trian Fly is not responsible in any way for the content, claims,
